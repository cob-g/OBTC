        ...
        <div class="mt-6 overflow-x-auto">
            <table class="min-w-full text-left text-sm">
                ...
                <tbody>
                    <?php if (!$challenge): ?>
                        <tr>
                            <td colspan="5" class="py-6 text-zinc-600">Create or activate a coach challenge to see the leaderboard.</td>
                        </tr>
                    <?php elseif (!$rows): ?>
                        <tr>
                            <td colspan="5" class="py-6 text-zinc-600">No leaderboard entries yet. Coaches need to join and record at least one weigh-in.</td>
                        </tr>
                    <?php endif; ?>
