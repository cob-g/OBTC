...
if ($role === 'admin') {
    ...
    $nav = [
        ...
        ['Coaches', url('/admin/coaches.php'), '<svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>'],
            ...
            <div class="flex items-center gap-3">
                <?php if ($user): ?>
                    ...
                    <div class="relative hidden lg:block">
                        <button onclick="toggleUserDropdown()" class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-molten to-amber-500 text-white hover:shadow-lg hover:shadow-orange-200/50 transition-all focus:outline-none focus:ring-2 focus:ring-molten focus:ring-offset-2">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                            </svg>
                        </button>
